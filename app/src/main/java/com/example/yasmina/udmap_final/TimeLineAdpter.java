...
import com.example.yasmina.udmap_final.utils.DateTimeUtils;
import com.example.yasmina.udmap_final.utils.VectorDrawerUtils;
import com.github.vipulasri.timelineview.TimelineView;

import java.util.List;

import com.example.yasmina.udmap_final.R;
import static com.example.yasmina.udmap_final.R.drawable.*;

/**
 * Created by HP-HP on 05-12-2015.
 */
public class TimeLineAdpter extends RecyclerView.Adapter<TimeLineViewHolder> {
    ...
    public TimeLineAdpter(List<TimeLineModel> feedList, Orientation orientation, boolean withLinePadding) {
        mFeedList = feedList;
    ...
    public void onBindViewHolder(TimeLineViewHolder holder, int position) {
        ...
        /*if(timeLineModel.getStatus() == OrderStatus.INACTIVE) {
            holder.mTimelineView.setMarker(VectorDrawerUtils.getDrawable(mContext, ic_marker_inactive, android.R.color.darker_gray));
        } else if(timeLineModel.getStatus() == OrderStatus.ACTIVE) {
            holder.mTimelineView.setMarker(VectorDrawerUtils.getDrawable(mContext, ic_marker_active, R.color.colorPrimary));
        } else {
